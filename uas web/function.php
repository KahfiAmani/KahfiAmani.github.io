...
$conn = mysqli_connect("localhost", "root", "", "db_teknisi");
...
function registrasiP($data) {
	...
	mysqli_query($conn, "INSERT INTO pelanggan VALUES(null,'$nama','$username','$hp','$email','$password')");
...
function registrasiT($data) {
	...
	$password = password_hash($password, PASSWORD_DEFAULT);
	// insert userbaru ke database
	mysqli_query($conn, "INSERT INTO teknisi VALUES(null,'$nama','$username','$hp','$email','$password','$keahlian','$alamat')");
	return mysqli_affected_rows($conn);
...
function order($data){
	...
	$query = "INSERT INTO orderperbaikan
				VALUES 
				(null,'$nama','$hp','$layananPerbaikan','$merk','$jenisPerbaikan', '$tanggal' , '$waktu', '$alamat', '$status', '$teknisi')
				";

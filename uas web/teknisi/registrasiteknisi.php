    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success fixed-top">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <li class="nav-item">
              <a class="nav-link active" href="loginteknisi.php">Login</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="row mt-3">
          <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="keahlian" aria-label="Default select example">
                    <option selected>--Pilih Bidang Keahlian--</option>
                    <option value="teknisi mobil">Teknisi Mobil</option>
                    <option value="teknisi pendingin">Teknisi Pendingin</option>
                    <option value="teknisi listrik">Teknisi Listrik</option>
                    <option value="teknisi electronic">Teknisi Electronic</option>
                    <option value="teknisi computer">Teknisi Computer</option>
                </select>
            </div>
            <div class="mb-3">
              ...
              <p class="mt-2">Sudah punya akun? <a href="loginteknisi.php">Login disini</a></p>
            </form>
          </div>
        </div>
      </div>
